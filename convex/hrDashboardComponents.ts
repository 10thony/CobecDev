...
export const initializeDefaultComponents = mutation({
  ...
  handler: async (ctx) => {
    ...
    const defaultComponents = [
      { id: "overview", name: "HR Overview", description: "Job-resume matching and business insights", order: 1 },
      { id: "search", name: "Semantic Search", description: "AI-powered search across jobs and resumes", order: 2 },
      { id: "leads-management", name: "Leads Management", description: "Manage procurement opportunity leads", order: 3 },
      { id: "procurement-links", name: "Procurement Links", description: "Import and verify procurement URLs for the map", order: 4 },
      { id: "kfc-management", name: "KFC Management", description: "Manage KFC points and employee nominations", order: 5 },
      { id: "data-management", name: "Data Management", description: "Import, export, and manage job postings and resumes", order: 6 },
      { id: "embeddings", name: "Embedding Management", description: "Manage AI embeddings and system optimization", order: 7 },
    ];
