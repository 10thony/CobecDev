      ...
      <div className="min-h-screen bg-mint-cream-900 bg-oxford-blue-DEFAULT py-8">
        <div className="max-w-4xl mx-auto px-4">
          <div className="flex justify-center items-center py-12">
            ...
            <span className="ml-2 text-mint-cream-600">Loading job details...</span>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-mint-cream-900 bg-oxford-blue-DEFAULT py-8">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <button
          onClick={() => navigate(-1)}
          className="flex items-center text-powder-blue-600 hover:text-blue-800 mb-6 transition-colors"
        >
        ...
        <div className="bg-berkeley-blue-DEFAULT rounded-lg shadow-md p-6 mb-6">
          ...
          <div className="border-t border-yale-blue-300 pt-4">
            <button className="w-full md:w-auto px-6 py-3 bg-yale-blue-DEFAULT text-white rounded-md hover:bg-yale-blue-600 transition-colors font-medium">
        ...
        <div className="mt-8 text-center">
          <button className="px-8 py-4 bg-yale-blue-DEFAULT text-white rounded-md hover:bg-yale-blue-600 transition-colors font-medium text-lg">
            Apply for this Position
          </button>
        </div>
      </div>
